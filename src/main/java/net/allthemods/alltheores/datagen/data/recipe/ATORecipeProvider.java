...
public class ATORecipeProvider extends RecipeProvider{
    ...
    protected void buildRecipes(RecipeOutput output) {
        ...
        ATOSetHelper.applyToVanillaIngot( set -> {
            ...
            // Hammer + Ore -> 2x Dust
            hammer(set.ORE_BLOCK_ITEM_TAG, 2, set.DUST.get()).save(output, hammerRecipeDir("ore", set.name, "dust"));
            // Hammer + Raw -> 2x Dust
            hammer(set.RAW_TAG, 2, set.DUST.get()).save(output, hammerRecipeDir("raw", set.name, "dust"));
            // Hammer + Ingot -> Dust
            hammer(set.INGOT_TAG, 1, set.DUST.get()).save(output, hammerRecipeDir("ingot", set.name, "dust"));
            ...
            smelting(set.DUST_TAG, set.INGOT)
                    ...
                    .save(output, smeltingRecipeDir("dust", set.name));
            blasting(set.DUST_TAG, set.INGOT)
                    .unlockedBy(String.format("has_%s_dust", set.name), has(set.DUST_TAG))
                    .save(output, blastingRecipeDir("dust", set.name));
            ...
            gear(set.INGOT_TAG, set.GEAR.get())
                    ...
                    .save(output, shapelessRecipeDir(set.name, "gear"));
            // Rod
            rod(set.INGOT_TAG, set.ROD.get())
                    .unlockedBy(String.format("has_%s_ingot", set.name), has(set.INGOT_TAG))
                    .save(output, shapelessRecipeDir(set.name, "rod"));
            // Plate
            plate(set.INGOT_TAG, set.PLATE.get())
                    .unlockedBy(String.format("has_%s_ingot", set.name), has(set.INGOT_TAG))
                    .save(output, shapelessRecipeDir(set.name, "plate"));
        });
        ...
        ATOSetHelper.applyToVanillaGem( set -> {
            ...
            hammer(set.ORE_BLOCK_ITEM_TAG, 2, set.DUST.get()).save(output, hammerRecipeDir("ore", set.name, "dust"));
            // Hammer + Gem -> Dust
            hammer(set.GEM_TAG, 1, set.DUST.get()).save(output, hammerRecipeDir("gem", set.name, "dust"));
        ...
        ATOSetHelper.applyToVanillaDebris( set -> {
            ...
            hammer(set.DEBRIS_ITEM_TAG, 2, set.SCRAP).save(output, hammerRecipeDir("debris", set.name, "scrap"));
            // Hammer + Ingot -> Dust
            hammer(set.INGOT_TAG, 1, set.DUST.get()).save(output, hammerRecipeDir("ingot", set.name, "dust"));
        ...
        ATOSetHelper.applyToIngot( set -> {
            ...
            uncompress(set.RAW_BLOCK_ITEM_TAG, set.RAW.get())
                    ...
                    .save(output, shapelessIORecipeDir("raw", set.name, "raw_block"));
            // 9x Raw -> Raw Block
            compress(set.RAW_TAG, set.RAW_BLOCK_ITEM.get())
                    .unlockedBy(String.format("has_raw_%st", set.name), has(set.RAW_TAG))
                    .save(output, shapelessIORecipeDir("raw_block", set.name, "raw"));

            // ##### Hammer #####

            // Hammer + Ore -> 2x Dust
            hammer(set.ORES.ORE_BLOCK_ITEM_TAG, 2, set.DUST.get()).save(output, hammerRecipeDir("ore", set.name, "dust"));
            // Hammer + Raw -> 2x Dust
            hammer(set.RAW_TAG, 2, set.DUST.get()).save(output, hammerRecipeDir("raw", set.name, "dust"));
            ...
            blasting(set.RAW_TAG, set.INGOT.get())
                    ...
                    .save(output, blastingRecipeDir("raw", set.name));
            smelting(set.RAW_TAG, set.INGOT.get())
                    .unlockedBy(String.format("has_raw_%s", set.name), has(set.RAW_TAG))
                    .save(output, smeltingRecipeDir("raw", set.name));
            ...
            blasting(set.RAW_BLOCK_ITEM_TAG, set.BLOCK_ITEM.get())
                    ...
                    .save(output, blastingRecipeDir("raw_block", set.name));
            smelting(set.RAW_BLOCK_ITEM_TAG, set.BLOCK_ITEM.get())
                    .unlockedBy(String.format("has_raw_%s_block", set.name), has(set.RAW_BLOCK_ITEM_TAG))
                    .save(output, smeltingRecipeDir("raw_block", set.name));
            ...
            blasting(set.ORES.ORE_BLOCK_ITEM_TAG, set.INGOT.get())
                    ...
                    .save(output, blastingRecipeDir("ore", set.name));
            smelting(set.ORES.ORE_BLOCK_ITEM_TAG, set.INGOT.get())
                    .unlockedBy(String.format("has_%s_ore", set.name), has(set.ORES.ORE_BLOCK_ITEM_TAG))
                    .save(output, smeltingRecipeDir("ore", set.name));
        });
        ...
        ATOSetHelper.applyToGem( set -> {
            ...
            uncompress(set.BLOCK_ITEM_TAG, set.GEM.get())
                    .unlockedBy(String.format("has_%s_block", set.name), has(set.BLOCK_ITEM_TAG))
                    .save(output, shapelessIORecipeDir("block", set.name, "gem"));
            // 9x Gem -> Block
            compress(set.GEM_TAG, set.BLOCK_ITEM.get())
                    .unlockedBy(String.format("has_%s", set.name), has(set.GEM_TAG))
                    .save(output, shapelessIORecipeDir("gem", set.name, "block"));

            // ##### Hammer #####

            // Hammer + Ore -> 2x Gem
            hammer(set.ORES.ORE_BLOCK_ITEM_TAG, 2, set.GEM.get()).save(output, hammerRecipeDir("ore", set.name, "gem"));
            // Hammer + Gem -> Dust
            hammer(set.GEM_TAG, 1, set.DUST.get()).save(output, hammerRecipeDir("gem", set.name, "dust"));
        });
        ...
        ATOSetHelper.applyToDust( set -> {
            ...
            uncompress(set.BLOCK_ITEM_TAG, set.DUST.get())
                    .unlockedBy(String.format("has_%s_block", set.name), has(set.BLOCK_ITEM_TAG))
                    .save(output, shapelessIORecipeDir("block", set.name, "dust"));
            // 9x Dust -> Block
            compress(set.DUST_TAG, set.BLOCK_ITEM.get())
                    .unlockedBy(String.format("has_%s", set.name), has(set.DUST_TAG))
                    .save(output, shapelessIORecipeDir("dust", set.name, "block"));
        ...
        compress(ATOTagRegistry.COPPER_NUGGET, Items.COPPER_INGOT)
                ...
                .save(output, shapelessIORecipeDir("nugget", "copper", "ingot"));
        // Ingot -> 9x Nugget
        uncompress(Tags.Items.INGOTS_COPPER, ATORegistry.COPPER_NUGGET.get())
                .unlockedBy("has_copper_ingot", has(Tags.Items.INGOTS_COPPER))
                .save(output, shapelessIORecipeDir("ingot", "copper", "nugget"));
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "invar", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .requires(ATOTagRegistry.ORE_HAMMERS)
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "steel", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "electrum", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "bronze", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "brass", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "lumium", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .requires(ATORegistry.NICKEL.DUST_TAG)
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "constantan", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "signalum", "alloy_blending"));
        ...
        ShapelessRecipeBuilder
                ...
                .requires(ATOTagRegistry.ORE_HAMMERS)
                .unlockedBy("has_hammer", has(ATOTagRegistry.ORE_HAMMERS))
                .save(output, shapelessIORecipeDir("dust", "enderium", "alloy_blending"));
    }
}
