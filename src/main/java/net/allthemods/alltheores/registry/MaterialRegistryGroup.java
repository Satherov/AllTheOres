...
import net.allthemods.alltheores.fluid.MoltenFlowingFluid;
...
public class MaterialRegistryGroup extends AlloyRegistryGroup{
    ...
    public final DeferredHolder<Fluid, MoltenFlowingFluid.Source> MOLTEN;
    public final DeferredHolder<Fluid, MoltenFlowingFluid.Flowing> MOLTEN_FLOWING;
    ...
    public MaterialRegistryGroup(String name, int fluidColor) {
        ...
        MOLTEN = BlockList.FLUIDS.register(String.format("molten_%s", name), () -> new MoltenFlowingFluid.Source(makeMoltenProperties(name)));
        MOLTEN_FLOWING = BlockList.FLUIDS.register(String.format("flowing_molten_%s", name), () -> new MoltenFlowingFluid.Flowing(makeMoltenProperties(name)));
    ...
    private MoltenFlowingFluid.Properties makeMoltenProperties(String name) {
        return new MoltenFlowingFluid.Properties(
                MOLTEN_TYPE,
