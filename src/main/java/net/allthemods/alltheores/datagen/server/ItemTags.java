...
public class ItemTags extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        GroupHelper.applyToOre(group -> {
            ...
            tag(group.ORE_ITEM_TAG).add(group.NETHER_ORE_ITEM.get());
            tag(group.ORE_ITEM_TAG).add(group.END_ORE_ITEM.get());
            tag(group.ORE_ITEM_TAG).add(group.OTHER_ORE_ITEM.get());
